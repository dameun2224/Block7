...
class EventHandler(GameActivity: GameActivity) {
    ...
    init {
        ...
        // 노인 약탈 이벤트
        val event_independence_plunderOldMan = Event_independence_ox_plunderOldMan(GameActivity, "event_independence_plunderOldMan", typeOX, 10000, defaultIsAvailable)
        // 1호관 동방 약탈 이벤트
