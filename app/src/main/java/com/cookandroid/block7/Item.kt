...
class Item(GameActivity: GameActivity, nameItem: String, nameKorItem: String, itemImage: ImageView) {
    ...
    fun updateItemVisibility() {
        if(isOwned && !isBroken) {
            ...
            when (nameItem) {
                "axe" -> itemImage.setImageResource(R.drawable.item_axe)
                "book" -> itemImage.setImageResource(R.drawable.item_book)
                "card" -> itemImage.setImageResource(R.drawable.item_card)
                "drone" -> itemImage.setImageResource(R.drawable.item_drone)
                "medkit" -> itemImage.setImageResource(R.drawable.item_medkit)
                "flashlight" -> itemImage.setImageResource(R.drawable.item_flashlight)
                "gasmask" -> itemImage.setImageResource(R.drawable.item_gasmask)
                "lock" -> itemImage.setImageResource(R.drawable.item_lock)
                "map" -> itemImage.setImageResource(R.drawable.item_map)
                "pesticide" -> itemImage.setImageResource(R.drawable.item_pesticide)
                "phone" -> itemImage.setImageResource(R.drawable.item_phone)
                "rattle" -> itemImage.setImageResource(R.drawable.item_rattle)
                "toolbox" -> itemImage.setImageResource(R.drawable.item_toolbox)
                else -> true
            }
        } else if(isOwned && isBroken) {
            itemImage.visibility = View.VISIBLE
            when (nameItem) {
                "axe" -> itemImage.setImageResource(R.drawable.item_axeb)
                "book" -> itemImage.setImageResource(R.drawable.item_bookb)
                "drone" -> itemImage.setImageResource(R.drawable.item_droneb)
                "medkit" -> itemImage.setImageResource(R.drawable.item_medkitb)
                "flashlight" -> itemImage.setImageResource(R.drawable.item_flashlightb)
                "gasmask" -> itemImage.setImageResource(R.drawable.item_gasmaskb)
                "pesticide" -> itemImage.setImageResource(R.drawable.item_pesticideb)
                "phone" -> itemImage.setImageResource(R.drawable.item_phoneb)
                "rattle" -> itemImage.setImageResource(R.drawable.item_rattleb)
                else -> true
            }
        }
        if(!isOwned) itemImage.visibility = View.GONE
        updateItemIconRes()
    }
