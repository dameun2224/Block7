    ...
    fun executeEventEffect(choose_value: Boolean) {
        ...
        for(memberTmp in memberListTmp) {
            ...
            if(memberTmp.getStateIsCrazy() != member?.getStateIsCrazy()) {
                ...
                if(member?.getStateIsCrazy() == true) addPostScript(member?.nameKor + "이(가) 미쳤습니다.\n")
            ...
            if(memberTmp.getStateIsHurt() != member?.getStateIsHurt()) {
                if(member?.getStateIsHurt() == true) addPostScript(member?.nameKor + "이(가) 다쳤습니다.\n")
            ...
            if(memberTmp.getStateIsSick() != member?.getStateIsSick()) {
                if(member?.getStateIsSick() == true) addPostScript(member?.nameKor + "이(가) 질병에 걸렸습니다.\n")
            ...
            if(memberTmp.getStateIsTired() != member?.getStateIsTired()) {
                if(member?.getStateIsTired() == true) addPostScript(member?.nameKor + "은(는) 피곤합니다.\n")
